...
from preprocessing.prosqa import DAG, sample_names_for_dag, generate_query_from_dag, get_names_and_entities
...
def generate_dataset(path: str, size: int, num_nodes: Tuple[int, int], num_layers: Tuple[int, int], connection_prob: float, names: str, entities: str):
    ...
    def generate_sample(idx: int) -> dict:
        ...
        """
        n_nodes = random.randint(num_nodes[0], num_nodes[1] - 1)
        n_layers = random.randint(num_layers[0], num_layers[1] - 1)
